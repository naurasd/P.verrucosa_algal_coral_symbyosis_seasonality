...
bio <- read_xlsx("Biological Data file Tilstra et al.xlsx",sheet="bio + env data",na="NA")
...
# Set biological variable names
bio_vars <- colnames(bio)[3:18]
...
# use \u03B4 for the greek letter delta to make sure it is being read properly
