...
symbio<-read_xlsx("Biological Data file Tilstra et al.xlsx",sheet="symbionts_chla_MI_nifH",na="NA")

# Change column names for parameters we need here

colnames(symbio)[3:5]<-c("chla","mi","symbio")
